...
import com.ruoyi.system.domain.AiChatAnalytics;
import com.ruoyi.system.service.IAiChatAnalyticsService;
...
{
    @Autowired
    private IAiChatAnalyticsService aiChatAnalyticsService;

    /**
     * 查询聊天统计列表
     */
    @PreAuthorize("@ss.hasPermi('system:analytics:list')")
    @GetMapping("/list")
     ...
     * 获取聊天统计详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:analytics:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增聊天统计
     */
    @PreAuthorize("@ss.hasPermi('system:analytics:add')")
     ...
     * 修改聊天统计
     */
    @PreAuthorize("@ss.hasPermi('system:analytics:edit')")
     ...
     * 删除聊天统计
     */
    @PreAuthorize("@ss.hasPermi('system:analytics:remove')")
