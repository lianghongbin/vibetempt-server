<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="总Token数" prop="totalTokens">
        <el-input
          v-model="queryParams.totalTokens"
          placeholder="请输入总Token数"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:conversation:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:conversation:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:conversation:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:conversation:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="conversationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="会话描述" align="center" prop="description" />
      <el-table-column label="状态：active-活跃,paused-暂停,ended-结束" align="center" prop="status" />
      <el-table-column label="消息数量" align="center" prop="messageCount" />
      <el-table-column label="总Token数" align="center" prop="totalTokens" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="总Token数" prop="totalTokens">
          <el-input v-model="form.totalTokens" placeholder="请输入总Token数" />
        </el-form-item>
        <el-form-item label="开始时间" prop="startTime">
          <el-date-picker clearable
...
<script>
import { listConversation, getConversation, delConversation, addConversation, updateConversation } from "@/api/system/conversation"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除对话会话编号为"' + ids + '"的数据项？').then(function() {
        return delConversation(ids)
      }).then(() => {
        this.getList()
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/conversation/export', {
        ...this.queryParams
