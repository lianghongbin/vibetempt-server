<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="当前会话ID" prop="currentConversationId">
        <el-input
          v-model="queryParams.currentConversationId"
          placeholder="请输入当前会话ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="当前会话ID" prop="currentConversationId">
          <el-input v-model="form.currentConversationId" placeholder="请输入当前会话ID" />
        </el-form-item>
...
<script>
import { listSession, getSession, delSession, addSession, updateSession } from "@/api/vibetempt/session"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除聊天会话状态编号为"' + ids + '"的数据项？').then(function() {
