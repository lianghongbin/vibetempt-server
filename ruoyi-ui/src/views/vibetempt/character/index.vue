<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="characterList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="角色类型：align="center" prop="characterType" />
...
<script>
import { listCharacter, getCharacter, delCharacter, addCharacter, updateCharacter } from "@/api/vibetempt/character"
