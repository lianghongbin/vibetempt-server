...
import com.ruoyi.vibetempt.service.AiCharacterMemoryService;
 ...
 */
@RestController
@RequestMapping("/vibetempt/memory")
public class AiCharacterMemoryController extends BaseController
{
    @Autowired
    private AiCharacterMemoryService aiCharacterMemoryService;

    /**
     * 查询角色记忆列表
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:memory:list')")
    @GetMapping("/list")
     ...
     * 导出角色记忆列表
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:memory:export')")
     ...
     * 获取角色记忆详细信息
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:memory:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增角色记忆
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:memory:add')")
     ...
     * 修改角色记忆
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:memory:edit')")
     ...
     * 删除角色记忆
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:memory:remove')")
