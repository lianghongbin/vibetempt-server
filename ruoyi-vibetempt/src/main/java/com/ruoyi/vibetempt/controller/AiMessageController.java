...
import com.ruoyi.vibetempt.service.AiMessageService;
 ...
 */
@RestController
@RequestMapping("/vibetempt/message")
public class AiMessageController extends BaseController
{
     ...
     * 查询消息列表
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:message:list')")
    @GetMapping("/list")
     ...
     * 导出消息列表
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:message:export')")
     ...
     * 获取消息详细信息
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:message:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增消息
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:message:add')")
     ...
     * 修改消息
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:message:edit')")
     ...
     * 删除消息
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:message:remove')")
