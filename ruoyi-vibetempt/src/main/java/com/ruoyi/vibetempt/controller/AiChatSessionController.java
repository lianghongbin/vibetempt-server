 ...
 */
@RestController
@RequestMapping("/vibetempt/session")
public class AiChatSessionController extends BaseController
{
     ...
     * 查询聊天会话状态列表
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:session:list')")
    @GetMapping("/list")
     ...
     * 导出聊天会话状态列表
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:session:export')")
     ...
     * 获取聊天会话状态详细信息
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:session:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增聊天会话状态
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:session:add')")
     ...
     * 修改聊天会话状态
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:session:edit')")
     ...
     * 删除聊天会话状态
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:session:remove')")
