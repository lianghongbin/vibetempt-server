...
import com.ruoyi.vibetempt.domain.AiCharacter;
import com.ruoyi.vibetempt.service.AiCharacterService;
 ...
 */
@RestController
@RequestMapping("/vibetempt/character")
public class AiCharacterController extends BaseController
{
     ...
     * 查询AI角色列表
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:character:list')")
    @GetMapping("/list")
     ...
     * 导出AI角色列表
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:character:export')")
     ...
     * 获取AI角色详细信息
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:character:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增AI角色
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:character:add')")
     ...
     * 修改AI角色
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:character:edit')")
     ...
     * 删除AI角色
     */
    @PreAuthorize("@ss.hasPermi('vibetempt:character:remove')")
