...
import com.ruoyi.system.service.AiConversationService;
...
public class AiConversationController extends BaseController
{
     ...
     * 查询对话会话列表
     */
    @PreAuthorize("@ss.hasPermi('system:conversation:list')")
    @GetMapping("/list")
     ...
     * 导出对话会话列表
     */
    @PreAuthorize("@ss.hasPermi('system:conversation:export')")
     ...
     * 获取对话会话详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:conversation:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增对话会话
     */
    @PreAuthorize("@ss.hasPermi('system:conversation:add')")
     ...
     * 修改对话会话
     */
    @PreAuthorize("@ss.hasPermi('system:conversation:edit')")
     ...
     * 删除对话会话
     */
    @PreAuthorize("@ss.hasPermi('system:conversation:remove')")
